...
namespace AngelHeart_Mendoza_Act_GUI
{
    public partial class EditForm : Form
    {
        ...
        private UserProfile GetUserProfile()
        {
            ...
            {
                Name = "Angel Heart Menoza",
                Age = 21,
                Address = "Poponto Pangasinan",
                ContactNumber = "09194449596",
                Email = "heart@gmail.com",
                Course = "BSIT",
                Year = "Third",
                ParentName = "Luvie Mendoza",
                ParentContact = "09127653921",
                Hobbies = "Singing, Watching Kdramas",
                Nickname = "Mes Hart"
            };
        }
